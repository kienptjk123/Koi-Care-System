              ...
              <div className='text-black grid grid-cols-2 grid-rows-4 lg:gap-8 gap-6'>
                ...
                <div className='relative col-span-1 '>
                  ...
                  {errors.createDateTime && (
                    <p className='absolute left-3 text-red-500 lg:text-lg text-sm'>{errors.createDateTime.message}</p>
                  )}
                </div>
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        <br />
                        The nitrite value can only be kept low by a sufficiently large biofilter and a high circulation
                        rate of the pond water volume (0.5 - 1.0 times per hour) via the filter.
                        <br />
                        If the value is very high in the short term, the pond can be salinated to a salt content of 0.3%
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        <br />
                        The phosphate value can be positively influenced by large water changes. If the value is very
                        high in the short term, perform several small partial water changes (5% of the water volume
                        daily) and reduce the amount of food.
                      </>
                    }
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        <strong>Optimal Range: 0 - 0.1 mg/l</strong>
                        <br />
                        The ammonium value can only be kept low by a sufficiently large biofilter and a high circulation
                        rate of the pond water volume (0.5 - 1.0 times per hour) via the filter.
                      </>
                    }
                ...
                <div className='relative col-span-1'>
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        water for this! Also measure the KH value of the water coming from the tap. If this is also too
                        low, the water must be artificially hardened using calcium carbonate or sodium hydrogen
                        carbonate. The supplement should not be added directly to the biofilter, as this can cause the
                        filter bacteria to die. It is best to add the agent to the water at the pond return.
                      </>
                    }
                  ...
                  {errors.carbonHardness && (
                    <p className='absolute left-3 text-red-500 lg:text-lg text-sm'>{errors.carbonHardness.message}</p>
                  )}
                </div>
                <div className='relative col-span-1'>
                  <label
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        <br />
                        The CO2 concentration in the water depends on both the pH value and the carbonate hardness (KH).
                        ...
                        lot of CO2 out of the water (e.g. through a strong air supply or a strong water circulation)
                        causes the pH value to increase.
                      </>
                    }
                  ...
                  {errors.carbonDioxide && (
                    <p className='absolute left-3 text-red-500 lg:text-lg text-sm'>{errors.carbonDioxide.message}</p>
                  )}
                </div>
                <div className='relative col-span-1'>
                  <label
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        <br />
                        Normally no salt is needed in a koi pond. For certain treatments, however, the salt content may
                        be increased to 0.5% for a short time (4 - 5 days). Careful: If the salt content is over 0.1%,
                        certain medicaments are NOT allowed to be administered in parallel! This especially applies to
                        medicaments which contain formalin or potassium permanganate.
                      </>
                    }
                ...
                <div className='relative col-span-1'>
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        <br />
                        In a lot of countries, chlorine is added to tap water supplies. However, chlorines are toxic to
                        fish (they damage the respiratory system). Thus, in regions where the tap water contains
                  ...
                  {errors.totalChlorine && (
                    <p className='absolute left-3 text-red-500 lg:text-lg text-sm'>{errors.totalChlorine.message}</p>
                  )}
                </div>
                <div className='relative col-span-1'>
                  <label
                  ...
                  <InfoBox
                    ...
                    content={
                      <>
                        ...
                        temperature and the desired growth. Our food calculator takes all of these factors into account
                        to compute the recommended amount of food.
                      </>
                    }
