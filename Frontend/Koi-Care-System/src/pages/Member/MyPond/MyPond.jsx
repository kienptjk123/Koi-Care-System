              ...
              <form onSubmit={handleSubmit(createPond)} noValidate>
                ...
                <div className='grid grid-cols-2 grid-rows-4 gap-6'>
                  ...
                  <div className='lg:mb-4 relative col-span-1'>
                    ...
                    />
                    {errors.name && <p className='text-red-500 absolute lg:text-lg text-sm'>{errors.name.message}</p>}
                  </div>
                  ...
                  <div className='lg:mb-4 relative col-span-1'>
                    ...
                    />
                    {errors.depth && <p className='text-red-500 absolute lg:text-lg text-sm'>{errors.depth.message}</p>}
                  </div>
                  ...
                  <div className='mb-4 relative col-span-1'>
                    ...
                    />
                    {errors.date && <p className='text-red-500 absolute lg:text-lg text-sm'>{errors.date.message}</p>}
                  </div>
                </div>
              </form>
            </div>
