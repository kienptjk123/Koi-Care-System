          ...
          {isImagePopupOpen && (
            ...
            >
              <div className='relative'>
                ...
                <button className='absolute top-4 right-4 text-white text-3xl font-bold' onClick={closePopup}></button>
              </div>
            </div>
          )}
          ...
          {koi && (
            ...
            >
              ...
              <p className='lg:mb-4 mb-2 lg:text-lg text-xs '>
                <strong>{koi.name || 'Unnamed Koi'}</strong> with size <strong>{koi.physique || 'Unknown'}</strong> has
                been swimming in the pond "<strong>{koi.koiPond?.name || 'No pond information'}</strong>" since{' '}
          ...
          >
            <form onSubmit={handleSubmit(onSubmitGrowth)} noValidate>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div className='relative'>
                  <input type='hidden' id='koiFishId' className='' defaultValue={koi.id} {...register('koiFishId')} />
                </div>
              </div>
            </form>
          </div>
