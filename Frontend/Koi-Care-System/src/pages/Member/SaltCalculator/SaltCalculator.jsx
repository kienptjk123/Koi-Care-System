        ...
        <div className='grid grid-cols-4 p-4 text-lg'>
            ...
            {selectedPond && (
              <div className='pl-4'>
                {selectedPond.salt && parseFloat(selectedPond.salt) < 0.1 ? (
                  <p>
                    <strong>Recommendation:</strong> The current salt concentration is too low. It is recommended to add
                    salt to bring the salinity up to the ideal range (0.1% - 0.3%). You need approximately{' '}
                  ...
                  <p>
                    <strong>Recommendation:</strong> The current salt concentration is too high. Consider performing
                    water changes to lower the salinity to the ideal range (0.1% - 0.3%). Follow the calculated water
                    changes needed.
                  </p>
                ) : (
                  <p>
                    <strong>Recommendation:</strong> The current salt concentration is within the ideal range (0.1% -
                    0.3%). Maintain this level for optimal Koi health.
                  </p>
                )}
              </div>
            )}
          ...
          <div className='lg:col-span-2 col-span-4 text-black border justify-center bg-white lg:py-20 py-5 px-5 rounded shadow'>
            ...
            <ul className='list-disc p-3'>
              ...
              <li className='lg:text-lg text-sm text-justify'>
                Use higher concentrations <strong>(0.4% - 2%)</strong>: only in cases of severe illness, and only for
                short periods.
              </li>
              <li className='lg:text-lg text-sm text-justify'>
            ...
            <p className='pt-2 lg:text-lg text-sm text-justify'>
              Always monitor the fish’s health and the salt concentration in the water to maintain a stable environment.
            </p>
            <p className='pt-2 lg:text-lg text-sm text-justify'>
              Note: If you're unsure about the proper salt dosage or your fish’s condition, consult with a veterinarian
              experienced.
            </p>
          </div>
        </div>
