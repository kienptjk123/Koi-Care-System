        ...
        {selectedPond && (
          <div className='mt-4'>
            ...
            {selectedPond.temperature && (
              <p>
                Follow on the current water parameters infomation We recommended the amount of food for their koi in
                pond : <strong>{calculateFoodBasedOnTemperature()}</strong>
              </p>
            )}
          </div>
        )}
                        ...
                        {temperatureOptions.map((temp) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded lg:text-lg text-sm  ${
                              selectedTemperature === temp ? 'bg-blue-500 text-white' : 'bg-gray-200 text-blue-500  '
                            }`}
                          >
                            {temp}
                          </button>
